...
namespace JobFjib_Empty
{
    ...
    partial void OnDiplomChanging(string value);
    partial void OnDiplomChanged();
    ...
    partial void OnNiveauEtude_IdNiveauChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Diplom", DbType="NVarChar(MAX)")]
		public string Diplom
		{
			...
			set
			{
				if ((this._Diplom != value))
				{
					this.OnDiplomChanging(value);
					this.SendPropertyChanging();
					this._Diplom = value;
					this.SendPropertyChanged("Diplom");
					this.OnDiplomChanged();
				}
			}
		}
    ...
    partial void OnIdDomaineChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Profession_Emploi", Storage="_Emploi", ThisKey="IdProfession", OtherKey="IdProfession")]
		public EntitySet<Emploi> Emploi
		{
			get
			{
	...
	public partial class Recrute : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _Emploi_idEmploi;
		
		private string _lettreMtv;
		
		private string _etatRec;
    ...
    partial void OnEmploi_idEmploiChanging(int value);
    partial void OnEmploi_idEmploiChanged();
    partial void OnlettreMtvChanging(string value);
    partial void OnlettreMtvChanged();
    partial void OnetatRecChanging(string value);
    partial void OnetatRecChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Emploi_idEmploi", DbType="Int NOT NULL")]
		public int Emploi_idEmploi
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_etatRec", DbType="NVarChar(10)")]
		public string etatRec
		{
			get
			{
				return this._etatRec;
			}
			set
			{
				if ((this._etatRec != value))
				{
					this.OnetatRecChanging(value);
					this.SendPropertyChanging();
					this._etatRec = value;
					this.SendPropertyChanged("etatRec");
					this.OnetatRecChanged();
				}
			}
		}
		...
		public Emploi Emploi
		{
			...
			set
			{
							...
							|| (this._Emploi.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Emploi_idEmploi = default(int);
					}
